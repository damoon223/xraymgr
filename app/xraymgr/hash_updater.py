...
class ConfigHashUpdater:
    ...
    پر کردن ستون config_hash در جدول links برای کانفیگ‌هایی که:
      ...
      - is_invalid = 0
    فعلاً فقط پروتکل VMess را پشتیبانی می‌کند.
    """
    ...
    def _extract_vmess_identity(self, outbound: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            network_norm = (str(network).strip().lower()) if isinstance(network, str) else ""
    ...
    def update_hashes(self) -> None:
        ...
        try:
            ...
            print(
                ...
                f"\n   rows skipped (non-vmess):{self.stats['rows_skipped_non_vmess']}"
